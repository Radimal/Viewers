 ...
 */
import { getReporterOrigin } from './radimalEndpoints';
 ...
 * @param {string} [baseUrl] - The reporter base URL; defaults to the
 *   environment-appropriate origin (the old hardcoded default was http://,
 *   which mixed-content-blocked from the https viewer)
 * @returns {Promise<void>}
 */
export async function downloadOrthancStudy(orthancStudyUUID, baseUrl = undefined, userId = null) {
  baseUrl = baseUrl ?? getReporterOrigin();
  if (!orthancStudyUUID) {
